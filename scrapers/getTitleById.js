...
const getTitleById = async (title_id) => {
  ...
  await axios({
    ...
    .then((HTML) => {
      ...
      const rating =
        $(".sc-94726ce4-4.dyFVGl > div > div:nth-child(1) > a > div > div > div.sc-7ab21ed2-0.fAePGh")
          .find("div.sc-7ab21ed2-2.kYEdvH > span.sc-7ab21ed2-1.jGRxWM").text();
      ...
      $("div[data-testid='title-cast-item']").each(function (){
        topCast.push({
          ...
          castId: $(this).find("a.sc-11eed019-1.jFeBIw").attr("href")
            .split("?")[0].split("/")[2],
          castUrl: BASE_URL + $(this).find("a.sc-11eed019-1.jFeBIw").attr("href")
            .split("?")[0],
          characterUrl: BASE_URL + $(this)
            .find("a[data-testid='cast-item-characters-link']").attr("href")
            .split("?")[0],
        });
      });

      $("section[data-testid='title-cast'] > ul > li:nth-child(1) > div > ul > li")
        .each(function(){
          director.push({
      ...
      $("section[data-testid='title-cast'] > ul > li:nth-child(2) > div > ul > li")
        .each(function(){
          writers.push({
            name: $(this).find("a").text(),
      ...
      $("section[data-testid='Storyline'] > div > ul.IjgYL.ipc-metadata-list--base")
        .find("li[data-testid='storyline-genres'] > div > ul > li")
        .each(function(){
          genres.push($(this).find("a").text());
        });

      $("section[data-testid='Details'] > div.sc-f65f65be-0.ktSkVi > ul > li:nth-child(7) > div > ul > li")
        .each(function(){
          productionCompanies.push($(this).find("a").text());
        });

      $("section[data-testid='BoxOffice'] > div.sc-f65f65be-0.ktSkVi > ul > li").each(function(){
        boxOffice[$(this).find("span.ipc-metadata-list-item__label").text()]
          = $(this).find("div > ul > li:nth-child(1) > span").text();
      });
      ...
      result.releaseDate =
        $("section[data-testid='Details'] > div.sc-f65f65be-0.ktSkVi > ul > li:nth-child(1) > div > ul > li > a")
          .text().replace("(United States)","");
      result.countryOfOrigin =
        $("section[data-testid='Details'] > div.sc-f65f65be-0.ktSkVi > ul > li:nth-child(2) > div > ul > li > a")
          .text();
      result.language =
        $("section[data-testid='Details'] > div.sc-f65f65be-0.ktSkVi > ul > li:nth-child(4) > div > ul > li > a")
          .text();
